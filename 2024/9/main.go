...
// input.txt is 20,000 characters, so max 200,000 values

func main() {
	// https://adventofcode.com/2024/day/9
	aoc.Local(part1, "part1", "sample.txt", 1928)
	aoc.Local(part1, "part1", "input.txt", 6349606724455)
	aoc.Local(part2, "part2", "sample.txt", 2858)
	aoc.Local(part2, "part2", "input.txt", 6376648986651)
}
