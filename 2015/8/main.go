...
func main() {
	...
	aoc.Local(part1, "part1", "sample.txt", 12)  // sample is (2-0)+(5-3)+(10-7)+(6-1) = 2 + 2 + 3 + 5 = 12
	aoc.Local(part1, "part1", "sample2.txt", 28) // sample is (2-0)+(5-3)+(10-7)+(6-1) = 2 + 2 + 3 + 5 = 12
	aoc.Local(part1, "part1", "input.txt", 1371)
	aoc.Local(part2, "part2", "sample.txt", 19)
