...
func main() {
	...
	aoc.Local(part1, "part1", "sample.txt", 58+43)
	aoc.Local(part1, "part1", "input.txt", 1598415)
	aoc.Local(part2, "part2", "sample.txt", 38)
	aoc.Local(part2, "part2", "input.txt", 3812909)
}
