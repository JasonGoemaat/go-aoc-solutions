...
func main() {
	...
	aoc.Local(part1, "part1", "sample.txt", 507) // note: added line to copy e to 'a' for solution
	aoc.Local(part1, "part1", "input.txt", 46065)
	// aoc.Local(part2, "part2", "sample.txt", 0)
	aoc.Local(part2, "part2", "input.txt", 14134)
}
